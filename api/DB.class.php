...
class DB
{
	...
	/** กำหนด Property $DB_HOST */
	private static $DB_USERNAME = 'root';
	/** กำหนด Property $DB_USERNAME */
	private static $DB_PASSWORD = '';
	/** กำหนด Property $DB_PASSWORD */
	private static $DB_DATABASE = 'ShopShop';
	/** กำหนด Property $DB_DATABASE */
	...
	{
		try {
			self::$connect = new PDO('mysql:host=' . self::$DB_HOST . '; dbname=' . self::$DB_DATABASE . '; charset=utf8',
