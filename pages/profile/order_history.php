...
<body class="bg-light">
  ...
  <section class="order_history py-5">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <h1 class="fw-normal display-5 text-center text-secondary"><i class="fas fa-history me-2"></i></i>ประวัติการสั่งซื้อ</h1>
        <div class="col-12">
          <section class="order_history_content mt-4 bg-light">
            <div class="row">
