    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">ข้อมูลเกี่ยวกับฉัน</li>
        </ol>
      </nav>
      <div class="row justify-content-center">
        <h1 class="fw-normal display-5 text-center text-secondary"><i class="far fa-info-circle me-2"></i>ข้อมูลเกี่ยวกับเรา</h1>
        <div class="col-12">
          <section class="about_content mt-4 bg-light">
            <div class="row">
