...
<body class="bg-light">
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand navbar-dark bg-dark px-2 fixed-top">
      ...
      <nav class="navbar-dark py-3">
        <ul class="navbar-nav">
          <li class="sidebar-item">
            <a href="" class="nav-link sidebar-link ps-4 active"><i class="fas fa-home me-2"></i></i>Dashboard</a>
          </li>
          <li class="my-2">
            <hr class="dropdown-divider">
          </li>
          ...
          <li class="sidebar-item">
            <a href="../product/" class="nav-link sidebar-link ps-4"><i class="fas fa-box-open me-2"></i>จัดการสินค้า</a>
          </li>
          <li class="sidebar-item">
