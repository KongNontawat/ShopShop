  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body px-2 px-sm-3 px-md-4 px-lg-5">
        ...
        <form id="form_login_admin" enctype="multipart/form-data">
          <div class="mb-3 input-value-admin">
          ...
          <div class="mb-4 input-value-admin">
...
<!-- Modal Register -->
<div class="modal fade" id="modal_register_admin" aria-hidden="true" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header mx-auto pb-2">
        <a href="../home/" class="navbar-brand text-dark">
      ...
      <div class="modal-body px-2 px-sm-3 px-md-4 px-lg-5">
        ...
        <form id="form_register" enctype="multipart/form-data">
          <div class="mb-3 input-value-reg-admin">
            <label for="input-username" class="form-label">ชื่อผู้ใช้</label>
          ...
          <div class="mb-4 input-value-reg-admin">
            <label for="input-password" class="form-label">รหัสผ่าน</label>
